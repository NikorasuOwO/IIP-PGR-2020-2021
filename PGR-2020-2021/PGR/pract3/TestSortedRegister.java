...
import pract3.utilPRG.CorrectReading;
/**
...
public class TestSortedRegister {
    ...
    public static void main(String[] args){
        ...
        File f = new File("pract3/data/" + nameIn);
        
        try{
            
            in = new Scanner(f);
            f = new File("pract3/data/" + "result.out");
            out = new PrintWriter(f);
            f = new File("pract3/data/" + "result.log");
        ...
        }catch (FileNotFoundException e){ System.out.println("Error al abrir el fichero " + f); 
        }finally{
            if (in != null) {in.close();} 
