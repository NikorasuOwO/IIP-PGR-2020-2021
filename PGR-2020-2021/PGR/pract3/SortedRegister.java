...
public class SortedRegister {
    ...
    /** Clasifica ordenadamente los datos leidos del Scanner sc, linea a linea.
    ...
    private void handleLine(String line) {
        ...
        if(amount < 0){throw new IllegalArgumentException("Cantidad negativa.");}
        
        this.m[month][day] += amount; // Por la comprobacion anterior, no se puede producir 
                                      // ArrayIndexOutOfBoundsException
    }
    
    /** Los datos registrados > 0 se escriben en pw, linea a linea
     *  con el formato
     *        dia  mes  cantidad
    ...
    /** Clasifica ordenadamente los datos leidos del Scanner sc. Se filtran
        ...
        int count = 1;
            while (sc.hasNext()) {
                ...
                try{
                    ...
                    err.println("ERROR. Linea " + count + ": Dato no entero.");
                }catch(IllegalArgumentException e){
                    err.println("ERROR. Linea " + count + ": " + e.getMessage());
                }finally{count++;}
            }
        return count;
        }
