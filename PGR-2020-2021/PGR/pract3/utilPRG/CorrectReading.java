    ...
    while(someerror){
        try{
            ...
            if(value < lowerBound || upperBound < value){
                throw new IllegalArgumentException("El número introducido no se encuentra "+ 
                "entre los bornes" + lowerBound + "y" + upperBound+". Por favor, introduce otro.");
            }
            someerror = false;
        }catch(InputMismatchException e){
