...
public class Point {
   ...
   public static final int HIGH_CROSS = 2;
    ...
    public int cross(Point u, Point v) {        
        ...
        double xCut = (this.y - pLow.y) * (pHigh.x - pLow.x)/ (pHigh.y - pLow.y) + pLow.x;
        ...
        if (pLow.y == pHigh.y){ //CASO 1
            cut = -1;
        }else{
            if(this.y == pHigh.y && this.x <= pHigh.x){ //Caso 2
                
                cut = 2;
            
            }else{
                if(this.y == pLow.y && this.x <= pLow.x){ //Caso 3
                cut = 0;
                }else{
                    if (this.x <= xCut && pLow.y < yCut && yCut < pHigh.y){ //Caso 4
                        cut = 1;
                    }else{ //caso 5
                        cut = -1;
                    }
